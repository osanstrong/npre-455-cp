...
\defplot{p1_setup}{A reactor consisting of three $yz$-infinite slabs (effectively two slabs, with symmetry at $x=0$), where the inner slab $0\leq x \leq a$ is composed of a fuel region $C$ and a moderator region $M$.\cite{novak_computer_2026}}
