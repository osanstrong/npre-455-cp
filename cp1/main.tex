...
\end{equation}
which, for the given material parameters, evaluates to $a=23.505$~cm.
...
\begin{equation}
    \label{eq:max-a}
    \phi_1(a)=0=C_2\cos\left(Ba_{max}\right) 
\end{equation}
which, for the given material parameters (and any non-trivial solution), evaluates to $a=46.852$~cm.\\
